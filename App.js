					...
					>
						<Scene key="root">
							...
							>
								...
								{/* 用户中心 */}
								<Scene key='userPage' hideDrawerButton 
									icon={({focused})=>
									<Icon color={focused?'red':'blue'} name='file'/>
									}
									title="用户中心">
									<Scene key="userinfor" component={Userinfor} hideNavBar/>
									<Scene key="fabu" component={Fabu} renderTitle="我的发布" navigationBarStyle={{backgroundColor:'red'}} titleStyle={{flex:1,textAlign:'center',color:'white'}}/>
								</Scene>
