                ...
                <View
                    ...
                    <View style={{ width: '100%', marginTop: 5 }}>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            ...
                            <Text style={{ fontSize: 15, marginLeft: 115, color: '#4f4e4e' }} onPress={()=>Actions.release()} title="我的发布">我的发布</Text>
                        </View>
                    </View>
                </View>
                <View style={{ marginTop: 14, marginLeft: '35%' }}>
                    <Text style={{ color: '#f24242' }}>
                        BINNU DHILLON | 退出
                    </Text>
                </View>
            </View>
